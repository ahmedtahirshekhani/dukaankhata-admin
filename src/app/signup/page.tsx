...
import { Store, User, Mail, Lock, Phone, ArrowRight, CheckCircle2, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden font-sans">
      <div className="w-full max-w-lg space-y-8 relative z-10">
        <div className="text-center space-y-3">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900">Create Merchant Account</h1>
          <p className="text-sm text-slate-500">Register new shop workspace</p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-xl space-y-6">
          ...
          <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 text-xs"
                  />
                </div>
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="merchant@dukaan.com"
                  className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500 text-xs"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-3 px-4 bg-sky-600 hover:bg-sky-700 font-semibold rounded-xl text-white shadow-lg shadow-sky-600/20 flex items-center justify-center space-x-2 transition text-xs disabled:opacity-50"
            >
              {loading ? (
